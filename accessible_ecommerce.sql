...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2026 at 10:04 AM
...
CREATE TABLE `accessibility_preferences` (
  ...
  `contrast_mode` enum('Normal','High Contrast') DEFAULT 'Normal',
  `simplified_layout` tinyint(1) DEFAULT 0,
...
--
ALTER TABLE `accessibility_preferences`
  ADD CONSTRAINT `accessibility_preferences_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
